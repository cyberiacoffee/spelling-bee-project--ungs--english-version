...
def dibujar(screen, letraPrincipal, letrasEnPantalla, candidata, puntos, segundos, palabrasAcertadas):
    ...
    ren2 = defaultFont.render("Points: " + str(puntos), 1, COLOR_TEXTO)
    if(segundos<15):
        ren3 = defaultFont.render("Time: " + str(int(segundos)), 1, COLOR_TIEMPO_FINAL)
    else:
        ren3 = defaultFont.render("Time: " + str(int(segundos)), 1, COLOR_TEXTO)
    ...
    ren4 = defaultFont.render("Discovered words:", 1, COLOR_TEXTO)
