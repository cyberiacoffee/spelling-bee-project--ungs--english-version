...
def pantallaGameOver(screen, palabrasAcertadas, puntos): ##Crea una pantalla de game over donde se muestran las palabras acertadas ordenadas alfabeticamente y los puntos obtenidos
    ...
    ren2 = defaultFont.render("Right words:", 1, COLOR_TEXTO)
    ...
    if puntos>0:
        ren3 = defaultFont.render("Total points: " + str(puntos), 1, COLOR_TEXTO)
        screen.blit(ren3, (ANCHO // 2 - ren3.get_width() // 2, 550))
    else:
        ren3 = defaultFont.render("Total points: " + str(puntos), 1, (255, 0, 0))
        screen.blit(ren3, (ANCHO // 2 - ren3.get_width() // 2, 550))
...
def mejoresPuntajes(screen): ##Muestra en pantalla los 10 mejores puntajes
    ...
    pygame.display.set_caption("Most points")
    ...
    ren1 = defaultFont.render("Best records:", 1, (255, 255, 0))
    screen.blit(ren1, (ANCHO // 2 - ren1.get_width() // 2, 30))
    ...
    ren2 = defaultFont.render("PRESS ENTER TO CLOSE THE GAME", 1, (255, 0, 0)) ## al finalizar el  juego, se debe presionar ENTER para cerrar el juego
...
def ingresarUsuario(screen):
    ...
    while teclasActivas: ##Mientras haya actividad en el teclado
        ...
        fondo = pygame.transform.scale(fondo, (ANCHO, ALTO))
        screen.blit(fondo, [0, 0])
        aviso = defaultFont.render("Write your user name:", True, (0,0,0))
